...
public class POIController {
    ...
    public ResponseEntity<POIZoneBusynessDTO> getPOIsByPOITypeName(@RequestBody POI lastPOI,
        ...
        List<POIBusynessDistanceRecommendationDTO> poiBusynessDistanceRecommendationDTOS = poiService.assignBusynessDistanceForPOIs(poiService.getPOIsByPOITypeName(poiTypeName), lastPOI, zoneBusynessMap, transitType);
        return ResponseEntity.ok(new POIZoneBusynessDTO(poiBusynessDistanceRecommendationDTOS, zoneBusynessMap));
    }
}
